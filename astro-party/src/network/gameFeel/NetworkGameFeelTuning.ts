...
export const NETWORK_GAME_FEEL_TUNING = {
  ...
  selfPrediction: {
    ...
    maxSoftCorrectionPerSnapshotPx: 36,
    correctionOffsetDecayPerSec: 12,
    maxRenderOffsetPx: 180,
    wallCorrectionMarginPx: 28,
    wallNormalCorrectionDamping: 0.5,
    velocityCorrectionBlendFactor: 0.35,
    angularCorrectionBlendFactor: 0.35,
